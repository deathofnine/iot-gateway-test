...
# === 从 /etc/device.cfg 获取的参数 ===
DEVICE_ID = "6a00bc177f2e6c302f6f8843_dht11_led_001"
BROKER = "b1d7c0faf7.st1.iotda-device.cn-north-4.myhuaweicloud.com"
PORT = 1883
CLIENT_ID = "6a00bc177f2e6c302f6f8843_dht11_led_001_0_0_2026051118"
...
class MQTTCloudSimulator:
    ...
    def send_led_command(self, status, request_id="test123"):
        ...
        status: "ON" 或 "OFF"
        """
        topic = f"$oc/devices/{DEVICE_ID}/sys/commands/request_id={request_id}"
        payload = json.dumps({
            "paras": {
                "status": status
            }
...
if __name__ == "__main__":
    ...
    rpc = RPCClient("192.168.137.114", 1234)
